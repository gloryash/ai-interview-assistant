...
本文档详细描述 AI 访谈助手的各个子模块设计，包括：
- 语音交互层（ASR/TTS/VAD）
- 访谈引擎层（InterviewEngine）
- 文档生成层（DocumentGenerator）
...
**文件位置**：`src/services/audio/AudioRecorder.ts`
...
**文件位置**：`src/services/audio/AudioPlayer.ts`
...
**文件位置**：`src/services/voice/SimpleVAD.ts`
...
**文件位置**：`src/services/asr/ParaformerASR.ts`
...
**文件位置**：`src/services/tts/CosyVoiceTTS.ts`
...
**文件位置**：`src/hooks/useRealtimeVoiceChat.ts`
...
### 3.7 访谈记录模块 (InterviewRecorder)

**文件位置**：`src/services/interview/InterviewEngine.ts`
